from SendEmail import send_mail_ru, send_gmail_com, get_attach_image, get_plain_mimie, get_attach_mime

if __name__ == '__main__':
    send_from = "ebobylev@gmail.com"
    send_to = ["beabooks@mail.ru"]  # "masternz@mail.ru",
